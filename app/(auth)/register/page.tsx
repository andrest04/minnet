...
function RegisterContent() {
  ...
  const handleUserTypeSelection = (userType: "resident" | "company") => {
    ...
    router.push(
      `/register/${userType}?identifier=${encodeURIComponent(
        identifier!
      )}&type=${type}`
    );
  };
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Eres parte de una comunidad local cercana a un proyecto
                    minero
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Trabajas en una empresa minera o gestoras de proyectos
                    sociales
                  </p>
                </div>
              </div>
